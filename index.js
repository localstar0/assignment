...
var userName = "husnain ALi";
var upperCase = userName.toUpperCase();
console.log(upperCase);
var userName1 = "HUSNAIN";
...
var name1 = ["Abdullah", "Kashif", "Rashid", "Zubair"];
...
let userName2 = ["admin", "Husnain", "Abdullah", "Taha", "Umar"];
...
let userName3 = ["Husnain", "Abdullah", "Haseeb", "hassan"];
...
let current_users = ["Husnain", "Abdullah", "ali", "haseeb", "Taha"];
let new_users = ["HUSNAIN", "Javid", "Umair", "Zubair", "Ijaz"];
...
let favPizza = ["lazania", "B.B.Q", "Bihari kabab"];
...
let listOfRivers = ["Chenab River", "Neelam River", "Kunar River",];
let listOfMountain = ["Mount Everest", "k2", "Nanga Parbat", "Ganga Choti"];
let listOfCity = ["London", "Washing DC", "Tokiyo", "Faisalabad"];
let listOfLanguage = ["English", "French", "Urdu", "Chanese", "Arabic"];
let river = [
    {
        name: "chenab",
        location: "sialkot"
